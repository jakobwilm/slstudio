...
cv::Mat EncoderPhaseShift4::getEncodingPattern(unsigned int depth) const{
...
void DecoderPhaseShift4::decodeFrames(cv::Mat &up, cv::Mat &vp, cv::Mat &mask, cv::Mat &shading) const{
