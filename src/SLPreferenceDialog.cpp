...
// Add LC4500 option
  ...
  ui->patternModeComboBox->addItem("2x3 Pattern Phase Shift",
                                   "CodecPhaseShift2x3");
  ...
  ui->diamondPatternCheckBox->setChecked(
      settings.value("projector/diamondPattern").toBool());
...
void SLPreferenceDialog::on_cameraComboBox_currentIndexChanged(
    const QString &arg1) {
